...
class FilteredStoreActivity : AppCompatActivity() {
    private lateinit var binding: ActivityFilteredStoreBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_filtered_store)
        setUpRv()
    ...
    private fun setUpRv(){
        ...
        binding.rvAll.apply {
            this.adapter = FilteredStoreOverviewAdapter(this@FilteredStoreActivity, list)
            this.layoutManager = LinearLayoutManager(this@FilteredStoreActivity)
        }
    }

    @SuppressLint("MissingInflatedId")
    fun showBottomFilterDialog(view: View){
